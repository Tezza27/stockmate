...
class SaleDetailScreen extends StatefulWidget {
  @override
  _SaleDetailState createState() => new _SaleDetailState();
}

class _SaleDetailState extends State<SaleDetailScreen> {
  List<DeliveryDetailCardClass> saleDetailCardList =
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: saleDetailCardList.length,
                        itemBuilder: (context, int index) {
                          return InkWell(
                              ...
                              child: DeliveryDetailCard(
                                  deliveryDetailCard: saleDetailCardList[index]));
                        }),
                  ),
                ),
              ],
